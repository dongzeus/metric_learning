...
class VA_lstm(nn.Module):
    def __init__(self, hidden_size=32 * 3, num_layers=3):
        ...
        self.conv1 = nn.Conv2d(in_channels=1, out_channels=8, kernel_size=(2, 32 * 3 * 2),
                               stride=32 * 3 * 2)  # output bn * 16 * 118
        ...
        self.vafc1 = nn.Linear(8 * 118, 1024)
