...
class VAMetric_conv(nn.Module):
    def __init__(self, framenum=120):
        ...
        self.conv1 = nn.Conv2d(in_channels=1, out_channels=8, kernel_size=(2, 128), stride=128)  # output bn*32*120
        # self.mp = nn.MaxPool1d(kernel_size=4)
        self.dp = nn.Dropout(0.5)
        self.conv2 = nn.Conv1d(in_channels=8, out_channels=8, kernel_size=8, stride=1)  # output bn*32*113
        self.fc3 = nn.Linear(in_features=8 * 113, out_features=1024)
