...
class VAMetric_conv(nn.Module):
    def __init__(self, framenum=120):
        ...
        self.conv1 = nn.Conv2d(in_channels=1, out_channels=128, kernel_size=(2, 128), stride=128)  # output bn*32*120
        # self.mp = nn.MaxPool1d(kernel_size=4)
        self.dp = nn.Dropout(0.5)
        self.conv2 = nn.Conv1d(in_channels=128, out_channels=64, kernel_size=8, stride=1)  # output bn*32*113
